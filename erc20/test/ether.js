...
contract('Ether sending should fail', (accounts) => {
    ...
    it("Proxy", async () => {
        ...
        await truffleAssert.fails(proxy.send(10, {from: ownerAccount})) 
    }) 
    ...
    it("Governor", async () => {
        ...
        await truffleAssert.fails(governor.send(10, {from: ownerAccount})) 
    }) 
    ...
    it("GovernedToken at Proxy", async () => {
        ...
        await truffleAssert.fails(proxiedToken.send(10, {from: ownerAccount})) 
    }) 
    ...
    it("ReplacementToken", async () => {
        ...
        await truffleAssert.fails(newToken.send(10, {from: ownerAccount})) 
    }) 
}) 
